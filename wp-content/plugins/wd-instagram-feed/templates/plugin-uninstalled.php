<?php $deactivate_url = wp_nonce_url('plugins.php?action=deactivate&amp;plugin=wd-instagram-feed/instagram-wd.php', 'deactivate-plugin_wd-instagram-feed/instagram-wd.php'); ?>
