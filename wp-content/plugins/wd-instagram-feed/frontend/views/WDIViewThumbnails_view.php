	...
	<div id="wdi_feed_<?php echo $wdi_feed_counter?>" class="wdi_feed_main_container">
		...
		<?php switch($feed_row['feed_display_view']){
			case 'load_more_btn':{
				...
				<div class="wdi_spinner "><div class="wdi_spinner_container"><div class="wdi_spinner_wrap"><div class="wdi_spinner_wrap_inner"><i class="wdi_load_more_spinner fa fa-spinner"></i></div></div></div></div></div>	
				<?php
				break;
			}
			case 'pagination':{
